<?php
/**
 * Template Name: Test 2 home page
 */

$do_not_duplicate = array();

get_header( 'test2' ); // Loads the header.php template. ?>


	<!-- http://tympanus.net/Development/SectionSeparators/   -->
	<header>
		<h1>Section Separators <span>Some inspiration for flat divider styles</span></h1>	
	</header>
